/*
    ...
    This program is licensed to Beyond Semiconductor. Beyond
    Semiconductor can redistribute it and/or modify it under the terms
    of the GNU Lesser General Public License as published by the Free
    Software Foundation, either version 3 of the License, or (at its
    ...
    Beyond Semiconductor should have received a copy of the GNU Lesser
